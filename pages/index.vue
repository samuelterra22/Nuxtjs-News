<template>
  <div>
    ...
    <div
      ...
      <!-- Sidebar -->
      <div
        class="bg-grey-darkest fixed w-1/5 min-h-screen"
        ...
        <div class="xl:py-2">
          ...
          <div class="group relative sidebar-item with-children">
            <a
              ...
              <svg
                ...
                width="24"
                height="24"
                class="h-6 w-6 text-grey-darker fill-current xl:mr-2"><path
          ...
          <div class="group relative sidebar-item with-children">
            <a
              href="#"
              class="no-underline block xl:flex xl:items-center text-center xl:text-left shadow-light xl:shadow-none py-6 xl:py-2 xl:px-4 border-l-4 border-blue-dark xl:bg-black bg-black xl:opacity-75">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                width="24"
            ...
            <div class="absolute xl:relative hidden xl:block pin-t left-full xl:pin-none w-48 xl:w-auto group-hover:block bg-black z-50 xl:z-auto">
              <a
                href="#"
                class="no-underline block text-left xl:flex xl:items-center shadow xl:shadow-none py-3 px-3 xl:px-4 border-l-4 border-transparent text-white hover:text-blue-dark text-xs">
                All Notification
              </a>
              <a
                href="#"
          ...
          <div class="group relative sidebar-item with-children">
            <a
              ...
              <svg
                ...
                height="24"
                class="h-6 w-6 text-grey-darker fill-current xl:mr-2"><path
                  d="M20 11.46V20a2 2 0 0 1-2 2h-3a2 2 0 0 1-2-2v-4h-2v4a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-8.54A4 4 0 0 1 2 8V7a1 1 0 0 1 .1-.45l2-4A1 1 0 0 1 5 2h14a1 1 0 0 1 .9.55l2 4c.06.14.1.3.1.45v1a4 4 0 0 1-2 3.46zM18 12c-1.2 0-2.27-.52-3-1.35a3.99 3.99 0 0 1-6 0A3.99 3.99 0 0 1 6 12v8h3v-4c0-1.1.9-2 2-2h2a2 2 0 0 1 2 2v4h3v-8zm2-4h-4a2 2 0 1 0 4 0zm-6 0h-4a2 2 0 1 0 4 0zM8 8H4a2 2 0 1 0 4 0zm11.38-2l-1-2H5.62l-1 2h14.76z"
                  class="heroicon-ui"/></svg>
          ...
          <div class="px-2">
            <a
              ...
              <svg
                ...
                width="24"
                height="24"
                class="h-4 w-4 mr-1 fill-current"><path
      ...
      <!-- Content -->
      <div
        class="bg-white h-full w-4/5 py-8 absolute pin-r overflow-y-auto"
        style="outline: 1px solid;">
        <div class="">
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci asperiores commodi corporis cumque cupiditate dolore doloribus fugiat ipsam ipsum iusto modi natus nobis, quae quidem sapiente tenetur unde velit veniam!</p>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci asperiores commodi corporis cumque cupiditate dolore doloribus fugiat ipsam ipsum iusto modi natus nobis, quae quidem sapiente tenetur unde velit veniam!</p>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci asperiores commodi corporis cumque cupiditate dolore doloribus fugiat ipsam ipsum iusto modi natus nobis, quae quidem sapiente tenetur unde velit veniam!</p>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci asperiores commodi corporis cumque cupiditate dolore doloribus fugiat ipsam ipsum iusto modi natus nobis, quae quidem sapiente tenetur unde velit veniam!</p>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci asperiores commodi corporis cumque cupiditate dolore doloribus fugiat ipsam ipsum iusto modi natus nobis, quae quidem sapiente tenetur unde velit veniam!</p>
          ...
          <div class="text-center w-full text-grey-darkest">
            ...
            <p class="py-2">
              <a
                href="https://github.com/sschoger/heroicons-ui"
                class="text-black font-bold">Hero Icons</a> by <a
                  href="https://twitter.com/steveschoger"
                  class="text-black font-bold">Steve Schoger</a></p>
            <p class="py-2">
              Adaptation of
              <a
                href="https://codyhouse.co/demo/responsive-sidebar-navigation/index.html"
                class="text-black font-bold">a CodyHouse Demo</a></p>
            <p class="py-2 text-sm">Made by <a
              href="https://webartisan.be"
              class="text-black font-bold">Simon Depelchin</a>, <a
                href="https://twitter.com/SimonDepelchin"
                class="text-black font-bold">@SimonDepelchin</a> on Twitter</p>
          </div>
        </div>
